var VsellmCatalog = (() => {
  ...
  var vsellmCatalog_exports = {};
  __export(vsellmCatalog_exports, {
    VSELLM_TEXT_MODELS: () => VSELLM_TEXT_MODELS,
    compareVsellmCatalogEntries: () => compareVsellmCatalogEntries,
    formatVsellmModelOptionLabel: () => formatVsellmModelOptionLabel,
    getSortedTextModels: () => getSortedTextModels,
    getVsellmCatalogEntry: () => getVsellmCatalogEntry,
    getVsellmProviderLabel: () => getVsellmProviderLabel
  });
  var VSELLM_TEXT_MODELS = [
  ...
  var getVsellmProviderLabel = (provider) => PROVIDER_LABELS[provider] ?? provider;
  var getVsellmCatalogEntry = (modelId) => VSELLM_TEXT_MODELS.find((entry) => entry.id === modelId);
  var formatVsellmModelOptionLabel = (entry) => entry.name.includes(":") ? entry.name : `${getVsellmProviderLabel(entry.provider)}: ${entry.name}`;
  var compareVsellmCatalogEntries = (a, b) => {
  ...
  var getSortedTextModels = () => [...VSELLM_TEXT_MODELS].sort(compareVsellmCatalogEntries);
  return __toCommonJS(vsellmCatalog_exports);
})();
